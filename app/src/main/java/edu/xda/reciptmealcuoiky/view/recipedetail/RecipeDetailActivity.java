...
import static edu.xda.reciptmealcuoiky.view.main.MainActivity.EXTRA_DETAIL;

public class RecipeDetailActivity extends AppCompatActivity implements DetailView {
    ...
    public void onErrorLoading(String err) {
        Utils.showDialogMessage(this, "Error", err);
    }
